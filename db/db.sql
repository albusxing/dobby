...
(
    ...
    method_name  varchar(20)                        null comment '方法名',
    req_url      varchar(200)                        null comment '请求地址',
    req_params   json                        null comment '请求参数',
    req_date     datetime default CURRENT_TIMESTAMP null comment '请求时间',
    req_duration bigint                             null comment '请求时长',
    exec_result  tinyint  default 0                 null comment '执行结果：0成功 1失败',
    exec_message json                      null comment '执行返回信息',
    create_time  datetime default CURRENT_TIMESTAMP null,
    update_time  datetime default CURRENT_TIMESTAMP null
)
    comment '接口请求日志';
